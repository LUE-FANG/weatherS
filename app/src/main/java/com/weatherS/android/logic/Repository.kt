...
import com.weatherS.android.logic.dao.PlaceDao
import com.weatherS.android.logic.model.Place
import com.weatherS.android.logic.model.Weather
    ...
    fun refreshWeather(lng: String, lat: String) = fire(Dispatchers.IO) {
        coroutineScope {
            val deferredRealtime = async {
                WeatherSNetwork.getRealtimeWeather(lng, lat)
            }
            val deferredDaily = async {
                WeatherSNetwork.getDailyWeather(lng, lat)
            }
